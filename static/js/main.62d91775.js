/*! For license information please see main.31868884.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
        ...
        function qn(e, n, t, r) {
          if (Wn) {
            var l = Yn(e, n, t, r);
            if (null === l) Hr(e, n, r, Jn, t), Dn(e, r);
            else if (
              (function (e, n, t, r, l) {
                switch (n) {
                  case "focusin":
              ...
              for (; null !== l; ) {
                ...
                if (
                  (null !== a && Sn(a),
                  null === (a = Yn(e, n, t, r)) && Hr(e, n, r, Jn, t),
                  a === l)
                )
                  break;
                l = a;
        ...
        function Qr(e, n) {
          for (var t = n + "Capture", r = []; null !== e; ) {
            ...
            5 === l.tag &&
              null !== a &&
              ((l = a),
              null != (a = Fe(e, t)) && r.unshift(Wr(e, a, l)),
              null != (a = Fe(e, n)) && r.push(Wr(e, a, l))),
              (e = e.return);
          }
          return r;
        }
        ...
        function qr(e, n, t, r, l) {
          for (var a = n._reactName, o = []; null !== t && t !== r; ) {
            ...
            5 === u.tag &&
              ...
              ((u = s),
              l
                ? null != (i = Fe(t, a)) && o.unshift(Wr(t, i, u))
                : l || (null != (i = Fe(t, a)) && o.push(Wr(t, i, u)))),
              (t = t.return);
          }
        ...
        function $l() {
          if (!Al && null !== jl) {
            ...
            try {
              ...
              throw (null !== jl && (jl = jl.slice(e + 1)), Ke(Ze, $l), l);
            } finally {
              (wn = n), (Al = !1);
            }
          }
        ...
        function Zl(e, n, t) {
          (Kl[ql++] = Yl), (Kl[ql++] = Xl), (Kl[ql++] = Jl), (Jl = e);
          var r = Yl;
          e = Xl;
          var l = 32 - on(r) - 1;
          (r &= ~(1 << l)), (t += 1);
          ...
          switch (e.tag) {
            ...
            case 13:
              return (
                ...
                ((t = null !== Jl ? { id: Yl, overflow: Xl } : null),
                (e.memoizedState = {
                  dehydrated: n,
                  treeContext: t,
                  retryLane: 1073741824,
                }),
                ((t = Fs(18, null, null, 0)).stateNode = n),
                (t.return = e),
                (e.child = t),
                (ta = e),
                (ra = null),
        ...
        function Wa(e, n, t, r) {
          ...
          "object" === typeof a && null !== a
            ? (l.context = Ca(a))
            : ((a = Fl(n) ? Tl : Pl.current), (l.context = Ll(e, a))),
        ...
        function vs(e, n) {
          ...
          if ((ka(), (zi = t), (_i.current = r), null !== Li))
            throw Error(a(261));
          return (Ti = null), (Fi = 0), Mi;
        }
        function ys() {
          for (; null !== Li; ) ws(Li);
        }
        function bs() {
          for (; null !== Li && !Je(); ) ws(Li);
        }
        function ws(e) {
        ...
        function xs() {
          if (null !== Ji) {
            var e = kn(Yi),
              ...
              t = wn;
            try {
              if (((Pi.transition = null), (wn = 16 > e ? 16 : e), null === Ji))
                var r = !1;
              else {
                if (((e = Ji), (Ji = null), (Yi = 0), 0 !== (6 & zi)))
                  throw Error(a(331));
                var l = zi;
        ...
        function Rs(e, n) {
          ...
          return (
            null === t
              ? (((t = Fs(e.tag, n, e.key, e.mode)).elementType =
                  e.elementType),
                (t.type = e.type),
        ...
        function Ms(e, n, t, r, l, o) {
          ...
          if (((r = e), "function" === typeof e)) Os(e) && (u = 1);
            ...
            e: switch (e) {
              ...
              case C:
                return (
                  ((e = Fs(12, t, n, 2 | l)).elementType = C), (e.lanes = o), e
                );
              case z:
                return (
                  ((e = Fs(13, t, n, l)).elementType = z), (e.lanes = o), e
                );
              case T:
                return (
                  ((e = Fs(19, t, n, l)).elementType = T), (e.lanes = o), e
                );
              case O:
                return Is(t, l, o, n);
              default:
  ...
  (t.p = "/"),
    (function () {
          ...
          v = function (e) {
            console.log("Clicked !"),
              g.includes(e.target.innerText) ||
                h([].concat(o(g), [e.target.innerText])),
              console.log(g);
          };
        return (0, i.jsxs)("div", {
          className: "offer",
          style: {
            borderLeft: r && l ? "4px solid hsl(180, 29%, 50%)" : "none",
          },
          children: [
            (0, i.jsxs)("div", {
              className: "left",
              children: [
                (0, i.jsx)("img", { src: t, alt: "" }),
                (0, i.jsxs)("div", {
                  className: "info",
                  children: [
                    (0, i.jsxs)("div", {
                      children: [
                        (0, i.jsx)("p", { className: "cName", children: n }),
                        (0, i.jsx)("p", {
                          className: "new",
                        ...
                        (0, i.jsx)("p", {
                          className: "featured",
                          style: { display: !0 === l ? "block" : "None" },
                          children: "FEATURED",
                        }),
                      ],
                    }),
                    (0, i.jsx)("p", { className: "position", children: a }),
                    (0, i.jsxs)("div", {
                      children: [
                        (0, i.jsx)("p", { className: "postDate", children: c }),
                        (0, i.jsx)("p", { className: "point", children: "." }),
                        (0, i.jsx)("p", { className: "contract", children: f }),
                        (0, i.jsx)("p", { className: "point", children: "." }),
                        (0, i.jsx)("p", { className: "location", children: d }),
                      ],
                    }),
                  ],
                }),
            ...
            (0, i.jsxs)("div", {
              className: "right",
              children: [
                (0, i.jsx)("p", { className: "role", onClick: v, children: u }),
                (0, i.jsx)("p", {
                  className: "level",
                  onClick: v,
                  children: s,
                ...
                p.map(function (e) {
                  return (0,
                  i.jsx)("p", { className: "lang", onClick: v, children: e }, p.indexOf(e));
                }),
                m.map(function (e) {
                  return (0,
                  i.jsx)("p", { className: "tool", onClick: v, children: e }, m.indexOf(e));
                }),
              ],
            }),
          ],
      ...
      function h(e) {
        ...
        return (0, i.jsxs)("div", {
          className: "console",
          style: { display: 0 === n.length ? "none" : "flex" },
          children: [
            (0, i.jsx)("ul", {
              className: "selected",
              children: n.map(function (e) {
                return (0,
                i.jsxs)("li", { className: "element", children: [(0, i.jsx)("p", { children: e }), (0, i.jsx)("div", { onClick: r, children: (0, i.jsx)(m, {}) })] }, n.indexOf(e));
              }),
            }),
            (0, i.jsx)("p", {
              onClick: function (e) {
      ...
      function v() {
        ...
        return (
          ...
          (0, i.jsxs)(i.Fragment, {
            children: [
              (0, i.jsx)("header", { className: "top" }),
              (0, i.jsxs)("main", {
                className: "root_inner",
                children: [
                  (0, i.jsx)(h, { keywords: t, setKeywords: r }),
                  (0, i.jsx)("div", {
                    className: "offers",
                    children: o.map(function (e) {
                      return (0,
                      i.jsx)(s, { keywordsState: t, setKeywords: r, company: e.company, logo: e.logo, isNew: e.new, isFeatured: e.featured, position: e.position, role: e.role, level: e.level, postedAt: e.postedAt, contract: e.contract, location: e.location, languages: e.languages, tools: e.tools }, e.id);
                    }),
                  }),
                ],
              }),
...
//# sourceMappingURL=main.31868884.js.map
